...
public class IOUtils {
	...
	public static String getResourcePath() {
		String path = Thread.currentThread().getContextClassLoader().getResource("").getPath(); // bin
	 ...
	 * @author isea533
	 */
	static public void zipFiles(File zip, String path, File... srcFiles) throws IOException {
	 ...
	 * @author isea533
	 */
	static public void zipFiles(ZipOutputStream out, String path, File... srcFiles) {
