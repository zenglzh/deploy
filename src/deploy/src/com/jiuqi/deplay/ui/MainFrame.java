...
import com.jiuqi.deplay.server.ConfigInfoService;
...
import com.jiuqi.deplay.util.ImageRes;
import com.jiuqi.deplay.util.SaveException;
import com.jiuqi.deplay.util.ShowMessage;
...
public class MainFrame {
	...
	private void fillField(ConfigEntity configEntity) {
		...
		ck_cluster.setSelected(Contants.ATTRIBUTE_ENABLE.equals(configEntity.getClusterEnable()));
		...
		ck_distri.setSelected(Contants.ATTRIBUTE_ENABLE.equals(configEntity.getDistEnable()));
