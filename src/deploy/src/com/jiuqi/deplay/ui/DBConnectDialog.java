...
import com.jiuqi.deplay.util.ConnectionInfo;
import com.jiuqi.deplay.util.DatabaseConnectionInfo;
import com.jiuqi.deplay.util.SettingsManager;
import com.jiuqi.deplay.util.SettingsManagerFactory;
...
public class DBConnectDialog extends JDialog {
	...
	public DBConnectDialog(final PageContext pageContext) {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(DBConnectDialog.class.getResource("/com/jiuqi/deplay/images/connect.png")));
